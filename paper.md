...
Joker builds on web customization ideas implemented by previous tools. Our novel contribution is a new interaction model that allows for interleaving extraction and augmentation, enabled by a unified formula language and a PBD interface.
...
Joker builds on insights from other tools that synthesize web extraction code from user demonstrations, and give users ways to inspect and modify the generated code.
