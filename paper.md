...
*MIT Course Catalog.* This set of tasks involved web scraping by demonstration and the use of web customization formulas: a) Scrape course titles, b) Scrapes course prerequisites, c) Add a column that indicates whether a course has a prerequisite & d) Add a column that indicates whether a course does not have a prerequisite and is offered in the fall.

*eBay.* This set of tasks involved web scraping by demonstration, the use of web scraping formulas and the use of web customization formulas: a) Scrape iPhone listing title, b) Scrape iPhone listing price, & c) Create a column that indicates whether an iPhone listing is sponsored.
